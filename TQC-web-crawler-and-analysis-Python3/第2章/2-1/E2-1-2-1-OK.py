...
for index, city in enumerate(city):
    ...
    res = requests.post('https://www.okmart.com.tw/convenient_shopSearch_result.aspx', data=data)
...
#將資料輸出成Excel
df_7_11_store.to_excel('E2-1-2-1-OK-output.xlsx', encoding="UTF-8", index=False)
